...
public class ElectricFurnaceRecipe implements Recipe<SimpleInventory> {
    ...
    public ElectricFurnaceRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<ElectricFurnaceRecipe> {
        ...
        @Override
        public ElectricFurnaceRecipe read(Identifier id, JsonObject json) {
        ...
        @Override
        public ElectricFurnaceRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, ElectricFurnaceRecipe recipe) {
